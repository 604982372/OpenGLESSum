...
import static com.xiwu.openglsum.utils.ShaderUtil.createProgram;
...
public class SixPointedStar1 {
	...
	public SixPointedStar1(MySurfaceView mv, float r, float R, float z, float[] color) {
	...
	public void initShader(MySurfaceView mv) {
		//加载顶点着色器的脚本内容
		mVertexShader = ShaderUtil.loadFromAssetsFile("vertex1.sh", mv.getResources());
		//加载片元着色器的脚本内容
