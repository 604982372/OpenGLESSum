...
import com.xiwu.openglsum.object.SixPointedStar1;
...
public class MySurfaceView extends GLSurfaceView {
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        switch (e.getAction()) {
           ...
           /* for(SixPointedStar1 h:mRenderer.ha)
            {
    ...
    private class SceneRenderer implements Renderer {
        SixPointedStar1 sixPointedStar;//六角星数组
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            // 创建六角星数组中的各个对象
            sixPointedStar = new SixPointedStar1(MySurfaceView.this, 0.4f, 1.0f, 0, new float[]{1f, 0f, 0.1f});
